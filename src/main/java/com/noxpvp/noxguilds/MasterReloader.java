...
public final class MasterReloader extends BaseReloader {
	 ...
	 * <br/>
	 *             <p/>
	 *             Must specify a module in {@link #reload(String)} instead or use {@link #reloadAll()} to reload all
	 *             modules. <br/>
	 *             <br/>
	 *             <p/>
	 *             <b> Warning using {@link #reloadAll()} May be intensive due to fact any plugin hooked into this will
	 *             reload its configs all at once.</b>
	 */
	@Deprecated
