...
public interface Persistant extends ConfigurationSerializable {
	...
	/**
	 * Lets the object know when it attempt to load any data from file that isn't already loaded with deserialization
	 * 
	 */
	public void load();
	
	/**
	 * Lets the object know when it should attempt to save data from file that is not already done with serialization
	 * 
	 */
	public void save();
