...
public class AttributeHider extends NoxPacketListener {
	...
	public static ItemStack removeAttributes(ItemStack i) {
		...
		final net.minecraft.server.v1_7_R3.ItemStack nmsStack = CraftItemStack.asNMSCopy(item);
		NBTTagCompound tag;
		if (!nmsStack.hasTag()) {
	...
	public void onPacketSending(PacketEvent event) {
		...
		if (type == PacketType.Play.Server.WINDOW_ITEMS) {
			...
			try {
				...
				final Field fieldMerchant = cM.getClass().getDeclaredField("merchant");
